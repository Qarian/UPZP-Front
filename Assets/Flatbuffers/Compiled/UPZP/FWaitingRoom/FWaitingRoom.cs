...
public struct FWaitingRoom : IFlatbufferObject
{
  ...
  public UPZP.FWaitingRoom.FTeam? Teams(int j) { int o = __p.__offset(6); return o != 0 ? (UPZP.FWaitingRoom.FTeam?)(new UPZP.FWaitingRoom.FTeam()).__assign(__p.__indirect(__p.__vector(o) + j * 4), __p.bb) : null; }
  ...
  public static Offset<UPZP.FWaitingRoom.FWaitingRoom> CreateFWaitingRoom(FlatBufferBuilder builder,
      int id = 0,
  ...
  public static VectorOffset CreateTeamsVector(FlatBufferBuilder builder, Offset<UPZP.FWaitingRoom.FTeam>[] data) { builder.StartVector(4, data.Length, 4); for (int i = data.Length - 1; i >= 0; i--) builder.AddOffset(data[i].Value); return builder.EndVector(); }
  public static VectorOffset CreateTeamsVectorBlock(FlatBufferBuilder builder, Offset<UPZP.FWaitingRoom.FTeam>[] data) { builder.StartVector(4, data.Length, 4); builder.Add(data); return builder.EndVector(); }
  ...
  public static Offset<UPZP.FWaitingRoom.FWaitingRoom> EndFWaitingRoom(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<UPZP.FWaitingRoom.FWaitingRoom>(o);
  }
};
