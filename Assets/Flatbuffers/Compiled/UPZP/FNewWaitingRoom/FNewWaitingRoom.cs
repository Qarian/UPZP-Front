...
namespace UPZP.FNewWaitingRoom
{
...
public struct FNewWaitingRoom : IFlatbufferObject
{
  ...
  public static Offset<UPZP.FNewWaitingRoom.FNewWaitingRoom> CreateFNewWaitingRoom(FlatBufferBuilder builder,
  ...
  public static Offset<UPZP.FNewWaitingRoom.FNewWaitingRoom> EndFNewWaitingRoom(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<UPZP.FNewWaitingRoom.FNewWaitingRoom>(o);
  }
  public static void FinishFNewWaitingRoomBuffer(FlatBufferBuilder builder, Offset<UPZP.FNewWaitingRoom.FNewWaitingRoom> offset) { builder.Finish(offset.Value); }
  public static void FinishSizePrefixedFNewWaitingRoomBuffer(FlatBufferBuilder builder, Offset<UPZP.FNewWaitingRoom.FNewWaitingRoom> offset) { builder.FinishSizePrefixed(offset.Value); }
};
